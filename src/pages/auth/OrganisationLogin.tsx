...
import { Users, Eye, EyeOff, ArrowLeft, Award } from 'lucide-react';
...
const OrganisationLogin: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log('Organisation login:', formData);
  };
      ...
      >
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-gray-900 mb-2">Organisation Login</h1>
            <p className="text-gray-600">NGO & Blood Bank Access</p>
          </div>
            ...
            >
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all pr-10"
          ...
          >
            <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-4">
              ...
              <p className="text-xs text-emerald-700 mt-1">
                For registered NGOs and blood banks only
              </p>
            </div>
